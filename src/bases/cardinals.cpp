...
double
Uclamp(long n, double x)
{
  return (T(n - 2, x) - T(n, x)) / 2.0;
}

double
Tclamp(long n, double x)
{
...
double
dUclamp(long n, double x)
{
  return (dT(n - 2, x) - dT(n, x)) / 2.0;
}

double
dTclamp(long n, double x)
{
...
double
ddUclamp(long n, double x)
{
  return (ddT(n - 2, x) - ddT(n, x)) / 2;
}

double
ddTclamp(long n, double x)
{
